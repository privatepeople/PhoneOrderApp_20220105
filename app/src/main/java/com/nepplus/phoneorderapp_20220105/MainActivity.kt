...
import com.nepplus.phoneorderapp_20220105.adapters.StoreAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mStoreList.add(StoreData("도미노 피자", "1577-3082", "https://post-phinf.pstatic.net/MjAxODEyMDVfMzYg/MDAxNTQzOTYxOTA4NjM3.8gsStnhxz7eEc9zpt5nmSRZmI-Pzpl4NJvHYU-Dlgmcg.7Vpgk0lopJ5GoTav3CUDqmXi2-_67S5AXD0AGbbR6J4g.JPEG/IMG_1641.jpg?type=w1200"))
        mStoreList.add(StoreData("미스터 피자", "1577-0077", "https://pbs.twimg.com/profile_images/1098371010548555776/trCrCTDN_400x400.png"))
